	...
	<div class="user-setting">
		...
		<el-form :model="form" label-width="10rem">
			...
			<div class="pageSize">
				...
				<p class="note form-note">
					页面容量代表在列表页面，一页能容纳多少项，用于分页计算。根据屏幕尺寸分为四种，
					mini：宽度390以下，代表设备iPhone SE； small：宽度391 -
					768，代表设备为一般手机； middle：宽度769 - 1200，代表设备为平板电脑；
					large：宽度1201 - 2559，代表设备为1080P显示器； 2k：宽度1201 -
					2560的设备； 4k：宽度4096及以上设备；<br />

					每个尺寸的四个输入框代表分页器容量的四个选择项，第一项为默认容量
				</p>
			</div>
