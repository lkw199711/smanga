export default {
	...
	account: {
		...
		formWarning:
			"The user name is 3-20 characters long and starts with a letter",
		note: {
	...
	mediaManage: {
		...
		note: {
			...
			browse:
				'"defaultBrowse": Select the default browsing method of comics in this media library. You can also adjust it through the top function menu of the browsing interface, but we still recommend that different types of comics be placed in different media libraries for easy management',
			directory:
				'"directoryType": This option supports adding one more level of directory to the path. For example, you want to manage comics by year "example/2022/manga/chapter/..."',
			removeFirst:
				'"removeFirst": In the "double page mode", by temporarily removing the first page in reading, you can combine the left and right pages of the cartoon into a whole picture by removing the even number of page numbers. Please change this item after getting familiar with the page numbers of the cartoon. You can also change this item temporarily through the function menu in the browsing interface.',
			direction:
				'"direction": In the "double page mode", change the display order of the first and second pictures so that the left and right pages of the cartoon can be combined into a whole picture. You can also change this item temporarily through the function menu in the browsing interface.',
		},
		place: {
	...
	path: {
		...
		confirm: {
			...
			title1: "",
			text1:
				"are you sure to delete this path? The associated manga and chapter also will be deleted!",
			title2: "confirm reScan",
			text2:
				"are you sure to reScan this path? The associated manga and chapter also will be cleared and rescanned to add!",
		},
	},
	mangaManage: {
		id: "mangaId",
