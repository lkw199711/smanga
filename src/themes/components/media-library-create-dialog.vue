...
<style scoped>
.tm-create-backdrop { position: fixed; inset: 0; z-index: 900; display: grid; place-items: center; padding: 2.4rem; background: rgba(15, 23, 42, .42); backdrop-filter: blur(0.3rem); }
.tm-create-dialog { width: min(82rem, 100%); max-height: min(88rem, calc(100vh - 4.8rem)); display: flex; flex-direction: column; overflow: hidden; color: var(--sd-text, #172033); background: var(--sd-card, #fff); border: 1px solid var(--sd-border, #e5e7eb); border-radius: 1.4rem; box-shadow: 0 2.4rem 6.4rem rgba(15, 23, 42, .22); }
.tm-create-header, .tm-create-actions { display: flex; align-items: center; justify-content: space-between; gap: 1.6rem; padding: 1.8rem 2.2rem; border-color: var(--sd-border, #e5e7eb); }
...
.tm-create-header h2 { font-size: 1.8rem; }
.tm-create-header p, .tm-section-heading p, .tm-field small { margin-top: 0.4rem; color: var(--sd-text-muted, #64748b); font-size: 1.2rem; line-height: 1.45; }
.tm-create-content { overflow: auto; padding: 2.2rem; }
.tm-create-section + .tm-create-section { margin-top: 2.4rem; padding-top: 2.4rem; border-top: 1px solid var(--sd-border, #e5e7eb); }
.tm-create-section h3 { font-size: 1.5rem; }
.tm-section-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 1.6rem; margin-bottom: 1.4rem; }
.tm-create-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 1.4rem 1.6rem; margin-top: 1.4rem; }
...
.tm-field input, .tm-field select, .tm-field textarea { box-sizing: border-box; width: 100%; padding: 0.9rem 1rem; color: var(--sd-text, #172033); font: inherit; font-weight: 400; background: var(--sd-back, #fff); border: 1px solid var(--sd-border, #dbe2ea); border-radius: 0.8rem; outline: none; resize: vertical; }
.tm-field input:focus, .tm-field select:focus, .tm-field textarea:focus { border-color: var(--sd-primary, #2563eb); box-shadow: 0 0 0 0.3rem color-mix(in srgb, var(--sd-primary, #2563eb) 15%, transparent); }
...
.tm-error, .tm-warning { margin: 1.6rem 0 0; padding: 1rem 1.2rem; border-radius: 0.8rem; font-size: 1.3rem; line-height: 1.45; }
.tm-error { color: #b42318; background: #fef3f2; }
.tm-warning { color: #92400e; background: #fffbeb; }
@media (max-width: 64rem) { .tm-create-backdrop { padding: 1.2rem; } .tm-create-content { padding: 1.6rem; } .tm-create-header, .tm-create-actions { padding: 1.4rem 1.6rem; } .tm-create-grid { grid-template-columns: 1fr; } .tm-field-wide, .tm-field-full { grid-column: auto; } }
</style>
