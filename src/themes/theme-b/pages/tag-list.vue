...
.tb-tag{padding:8px 16px;background:rgba(255,255,255,0.8);border:1px solid rgba(255,255,255,0.1);border-radius:20px;font-size:13px;color:#1f2937;cursor:pointer;transition:all .15s;display:flex;align-items:center;gap:8px}
.tb-tag:hover{background:rgba(168,85,247,0.3);border-color:rgba(168,85,247,0.5)}
.tb-tag-count{font-size:11px;color:#9ca3af;background:rgba(255,255,255,0.8);padding:1px 6px;border-radius:8px}
.tb-empty{text-align:center;padding:60px;color:#9ca3af}
</style>
