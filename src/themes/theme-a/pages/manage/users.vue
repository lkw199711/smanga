...
/* Badge */
.ta-badge { padding: 0.2rem 0.8rem; border-radius: 1rem; font-size: 1.1rem; font-weight: 500; white-space: nowrap; }
...
.ta-field input:focus { border-color: #2563eb; box-shadow: 0 0 0 0.2rem rgba(37,99,235,.12); }
...
.ta-field-group { display: flex; flex-direction: column; gap: 0.8rem; }
.ta-field-title { font-size: 1.3rem; font-weight: 600; color: #374151; margin: 0; }
.ta-checkbox { display: flex; align-items: center; gap: 0.8rem; font-size: 1.3rem; color: #4b5563; cursor: pointer; }
.ta-form-note { font-size: 1.2rem; color: #9ca3af; line-height: 1.6; }
.ta-form-note p { margin: 0.2rem 0; }
