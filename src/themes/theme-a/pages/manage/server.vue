    ...
    <div class="ta-card ta-card-section">
      ...
      <div class="ta-form">
        ...
        <div class="ta-form-row">
          ...
          <input v-model="form.scan.interval" class="ta-input" placeholder="cron表达式" style="width:240px" />
        ...
        <div class="ta-form-row">
          ...
          <input v-model="form.scan.mediaPosterInterval" class="ta-input" placeholder="cron表达式" style="width:240px" />
          <span class="ta-form-hint">cron表达式</span>
        ...
        <div class="ta-form-row">
          ...
          <input v-model="form.sync.interval" class="ta-input" placeholder="cron表达式" style="width:240px" />
          <span class="ta-form-hint">cron表达式</span>
    ...
    <div class="ta-card ta-card-section">
      ...
      <div class="ta-form">
        <div class="ta-form-row">
          ...
          <input v-model="form.ssl.pem" class="ta-input" placeholder="PEM文件路径" style="width:400px" />
        </div>
        <div class="ta-form-row">
          <span class="ta-form-label">KEY 文件路径</span>
          <input v-model="form.ssl.key" class="ta-input" placeholder="KEY文件路径" style="width:400px" />
        </div>
        <div class="ta-form-row">
    ...
    <div class="ta-card ta-card-section">
      ...
      <div class="ta-form">
        <div class="ta-form-row">
          ...
          <input v-model.number="form.compress.poster" class="ta-input" type="number" style="width:120px" />
        ...
        <div class="ta-form-row">
          ...
          <input v-model.number="form.compress.saveDuration" class="ta-input" type="number" style="width:120px" />
    ...
    <div class="ta-card ta-card-section">
      ...
      <div class="ta-form">
        ...
        <div class="ta-form-row">
          ...
          <input v-model.number="form.queue.workers.background.concurrency" class="ta-input" type="number" min="1" max="10" style="width:80px" />
        ...
        <div class="ta-form-row">
          ...
          <input v-model.number="form.queue.workers.compress.concurrency" class="ta-input" type="number" min="1" max="10" style="width:80px" />
        ...
        <div class="ta-form-row">
          ...
          <input v-model.number="form.queue.attempts" class="ta-input" type="number" min="1" max="10" style="width:80px" />
        ...
        <div class="ta-form-row">
          ...
          <input v-model.number="form.queue.timeout" class="ta-input" type="number" style="width:120px" />
        ...
        <div class="ta-form-row">
          ...
          <input v-model.number="form.queue.pollIntervalMs" class="ta-input" type="number" style="width:120px" />
          <span class="ta-form-hint">毫秒</span>
        ...
        <template v-if="form.p2p.enable">
          ...
          <template v-if="form.p2p.role.node">
            <div class="ta-form-row">
              ...
              <input v-model="form.p2p.node.nodeName" class="ta-input" style="width:240px" />
            ...
            <div class="ta-form-row">
              ...
              <input v-model="form.p2p.node.publicUrl" class="ta-input" placeholder="smanga.com:9797/api" style="width:360px" />
            ...
            <div class="ta-form-row">
              ...
              <input v-model.number="form.p2p.node.heartbeatInterval" class="ta-input" type="number" style="width:100px" />
          ...
          <template v-if="form.p2p.role.tracker">
            <div class="ta-form-row">
              ...
              <input v-model="form.p2p.tracker.publicUrl" class="ta-input" placeholder="http://tracker.example.com:9797/api" style="width:400px" />
            ...
            <div class="ta-form-row">
              ...
              <input v-model="form.p2p.tracker.syncKey" class="ta-input" style="width:360px" placeholder="留空不启用同步" />
            ...
            <div class="ta-form-row" v-if="form.p2p.tracker.syncKey">
              ...
              <input v-model.number="form.p2p.tracker.syncIntervalSec" class="ta-input" type="number" style="width:100px" />
              <span class="ta-form-hint">秒</span>
...
.ta-card { background: #fff; border: 1px solid #eaeaea; border-radius: 12px; padding: 20px 24px; }
.ta-card-section { margin-bottom: 20px; }
.ta-section-title { font-size: 15px; font-weight: 600; margin: 0 0 16px 0; color: #1f2937; }
.ta-form { display: flex; flex-direction: column; gap: 14px; }
.ta-form-row { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; }
.ta-form-label { width: 150px; font-size: 13px; font-weight: 500; color: #374151; flex-shrink: 0; }
.ta-form-hint { font-size: 12px; color: #9ca3af; }
.ta-input { padding: 7px 12px; border: 1px solid #eaeaea; border-radius: 8px; font-size: 13px; outline: none; }
.ta-input:focus { border-color: #2563eb; }
.ta-select { padding: 7px 12px; border: 1px solid #eaeaea; border-radius: 8px; font-size: 13px; outline: none; background: #fff; }
.ta-select:focus { border-color: #2563eb; }
.ta-btn-primary,.ta-btn-ghost,.ta-btn-sm { cursor: pointer; font-size: 13px; border-radius: 8px; }
