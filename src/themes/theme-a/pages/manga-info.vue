    ...
    <div class="ta-info-content">
      ...
      <div class="ta-meta-section">
        ...
        <div class="ta-meta-grid">
          ...
          <div class="ta-meta-item ta-meta-tags">
            <span class="ta-meta-label">标签</span>
            <div class="ta-meta-value ta-meta-value-tags">
              <TagChip
...
async function startRead() {
  try {
    ...
    if (chapterToRead?.chapterId) {
      // reader 读取的是 localStorage.pageJump 作为初始页码，
      // 仅设置 browse.page 无法跳转到目标页，必须同步写入 pageJump。
      if (jumpPage > 1) {
